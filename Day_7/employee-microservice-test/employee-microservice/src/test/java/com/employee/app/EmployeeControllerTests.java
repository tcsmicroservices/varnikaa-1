...
public class EmployeeControllerTests {
    ...
    private ResultActions processApiRequest(String api, HttpMethod methodType, String name, Employee employee) {
        ...
        private static Employee createEmployee(String name, String empId, String salary, String department) {
            Employee employee1 = new Employee(name,empId,salary,department);
            return employee1;
        }
